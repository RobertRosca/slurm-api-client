...
from slurm.client.api.openapi_api import AsyncOpenapiApi, SyncOpenapiApi
from slurm.client.api.slurm_api import AsyncSlurmApi, SyncSlurmApi
from slurm.client.exceptions import ResponseHandlingException, UnexpectedResponse
...
class AsyncApis(Generic[ClientT]):
    def __init__(self, client: ClientT):
        ...
        self.openapi_api = AsyncOpenapiApi(self.client)
        self.slurm_api = AsyncSlurmApi(self.client)
...
class SyncApis(Generic[ClientT]):
    def __init__(self, client: ClientT):
        ...
        self.openapi_api = SyncOpenapiApi(self.client)
        self.slurm_api = SyncSlurmApi(self.client)
