...
**accrue_time** | **str** | time job is eligible for running | [optional] 
...
**eligible_time** | **str** | time job is eligible for running | [optional] 
**end_time** | **str** | time of termination, actual or expected | [optional] 
...
**job_resources** | [**V0036JobResources**](V0036JobResources.md) |  | [optional] 
